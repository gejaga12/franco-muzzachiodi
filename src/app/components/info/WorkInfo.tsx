...
const WorkInfo = () => (
  <section id='workinfo'>
    {/* Sección Blanca */}
    <div className="bg-gray-900 dark:bg-white text-black dark:text-white sm:px-10 md:px-20 lg:px-28 xl:px-32 py-5 flex flex-col md:flex-row items-center justify-center">
      <GoogleMapComponent />
    </div>
    ...
    <div className="bg-gray-900 dark:bg-gray-700 text-white dark:text-gray-300 p-8 flex flex-col items-center justify-center">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div data-aos="zoom-in" className='p-2'>
          ...
          <p className="hover:text-gray-400 transition-colors duration-200 text-white">Medios de comunicación disponibles las 24hs.</p>
        </div>
      </div>
    </div>
  </section>

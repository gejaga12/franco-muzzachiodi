...
const ServiceCard: FC<ServiceCardProps> = ({ title, imageSrc, description, additionalInfo, link }) => {
  ...
  return (
    <div className="relative bg-black dark:bg-black rounded-lg shadow-lg overflow-hidden flex flex-col md:flex-row transition-transform transform hover:scale-105" data-aos="fade-up">
